...
|---|---|---|
| **Obsidian** | `obs` | First launch: open `/home/user/workspace/knowledge-management-system` as vault |
...
|---|---|---|
| `OBSIDIAN_VAULT` | `/home/user/workspace/knowledge-management-system` | Vault root |
...
```bash
# crontab -e
3 7 * * * /usr/bin/bash /home/user/workspace/knowledge-management/scripts/todo-summary.sh --output
3 12 * * * /usr/bin/bash /home/user/workspace/knowledge-management/scripts/todo-summary.sh --output
3 15 * * * /usr/bin/bash /home/user/workspace/knowledge-management/scripts/todo-summary.sh --output
```
...
screenshot-directory=/home/user/workspace/knowledge-management-system/attachments
